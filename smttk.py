...
try:
    ...
    def archive(datadir, link):
        ...
        E.g. if a file has the path 'data/20170908-120245/inputs/generated_data.dat',
        it is moved to 'data/inputs/generated_data.dat'. In general,
        '[datadir]/[timestamp]/[dir1]/.../[dirn]/[filename]' -> '[datadir]/[dir1]/.../[dirn]/[filename]'
                ...
                for dirpath, dirnames, filenames in os.walk(path):
                    for filename in filenames:
                        ...
                        timestamp_idx = len(datadir.split('/'))
                            # Assuming the label directory is immediately after
